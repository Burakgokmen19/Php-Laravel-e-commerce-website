        ...
        <div class="row align-items-start align-items-md-center justify-content-end">
          <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
            ...
            <div class="intro-text text-center text-md-left">
              ...
              <p>
                <a href="{{url('/').'/'.$slider->link}}" class="btn btn-sm btn-primary">Products</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
            <a class="block-2-item" href="{{route('womanproducts')}}">
              <figure class="image">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <a class="block-2-item" href="{{route('childproducts')}}">
              <figure class="image">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <a class="block-2-item" href="{{route('manproducts')}}">
              <figure class="image">
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-12 col-lg-5 text-center pl-md-5">
            ...
            <p>Up to 50% off selected products throughout the month of July</p>
            <p><a href="discountProducts" class="btn btn-primary btn-sm">Shop Now</a></p>
          </div>
        </div>
      </div>
    </div>
