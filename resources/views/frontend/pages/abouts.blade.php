          ...
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                ...
                <a href="https://youtu.be/blcZKSW8oxk" class="play-button popup-vimeo"><span class="ion-md-play"></span></a>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="text">
              <h2 class="text-uppercase">{{$about->text_3}} Support</h2>
              <p> {{$about->text_3_content1}}</p>
            </div>
          </div>
        </div>
      </div>
