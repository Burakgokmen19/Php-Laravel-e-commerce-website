...
<div class="bg-light py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12 mb-0"><a href="{{route('cart')}}">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Cart</strong></div>
      </div>
    </div>
  </div>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><button type="submit" class="btn btn-primary btn-sm">X</a></td>
                  </form>
                </tr>
                @endforeach
                @endif
